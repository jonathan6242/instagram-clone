  ...
  return (
    ...
    <div className="px-5 py-4 md:pb-0 relative z-0">
      <div className="flex justify-between items-center mb-3">
        {/* Actions */}
        <div className="flex w-full space-x-4 text-2xl animated-bg">
          &nbsp;
        </div>
      </div>
      <div className="my-4 font-semibold w-32 animated-bg">&nbsp;</div>
      <p className="line-clamp-4 w-full h-10 animated-bg">
      </p>
